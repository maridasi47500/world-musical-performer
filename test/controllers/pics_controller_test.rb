...
class PicsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create pic" do
    assert_difference("Pic.count") do
      post pics_url, params: { pic: { composer: @pic.composer, pic: @pic.pic, title: @pic.title } }
    end
  ...
  test "should update pic" do
    patch pic_url(@pic), params: { pic: { composer: @pic.composer, pic: @pic.pic, title: @pic.title } }
